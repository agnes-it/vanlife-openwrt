    ...
    var vueComponent = Vue.extend({
        ...
        methods: {
                ...
                if (description != null && description.length == 0) {
                    ...
                    if (this.clients[index].passphrase) {
                        data = {
                            ...
                            passphrase: password == null ? "" : password.trim()
                        };
                    } else {
                        data = {
                            clientid: id,
            ...
            addVpnClient: function addVpnClient() {
                ...
                var data = {}
                data.description = that.dspText.trim()
                if (that.needauth) {
                    data.username = that.usText.trim()
                    data.password = that.pswText.trim()
                }
                if (that.needInfo) {
                    data.passphrase = that.passText.trim()
                }
                that.addState = true;
